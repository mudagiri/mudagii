...
/* === PROFILE CTA TAP-ANCHOR PATCH 2026-09-25 ===
   Keep Q1-Q5 and the "家計スキャンを開始" CTA in one stable thumb zone.
   The panel may contain different controls, but the CTA itself must not drift.
*/
...
/* Q1's native select used to alter the content flow enough to move the CTA.
   Keep all profile controls in the content area above the fixed CTA. */
.pre-profile .pre-input-wrap {
  margin-bottom: 0 !important;
}

/* Short-height phones: preserve the same tap anchor and compress content above it,
   rather than moving the primary action. */
@media (max-height: 720px) {
  .pre-profile .pre-panel,
  .pre-complete .pre-panel {
